...
export const metadata: Metadata = {
  title: 'Interdisciplinary Unit Guide — Banyan Global Learning',
  description:
    'Guide for using Global Learning Live as the core of an MYP interdisciplinary unit.',
}

const PDF_PATH = '/documents/Interdisciplinary_Unit_Guide.pdf'

export default function InterdisciplinaryUnitGuidePage() {
  return (
    <>
      <SiteHeader />
      ...
      <main className="bg-neutral-50 min-h-screen">
        ...
        <section className="container-site py-8">
          <div className="bg-white rounded-xl border border-neutral-200 shadow-sm overflow-hidden">
            <iframe
              src={PDF_PATH}
              title="Interdisciplinary Unit Guide"
              className="w-full"
